...
RUTA_CARPETA_J1PF = r"C:\Users\juanmgart\Documents\BUSCADOR\JPMCONTADERO"
...
SHEET_NAME = "JPMCONTADERO"
CARPETA_PDF = r"C:\Users\juanmgart\Documents\BUSCADOR\JPMCONTADERO\pdf"
CARPETA_REVISION = r"C:\Users\juanmgart\Documents\BUSCADOR\JPMCONTADERO\revision"
...
for index, row in df.iterrows():
    ...
    with open(os.path.join(CARPETA_REVISION, f'{date.today()}_revision_JPMCONTADERO.txt'), 'a') as txt_file:
        if found:
