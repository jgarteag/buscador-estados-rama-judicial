...
RUTA_CARPETA_J1PF = r"C:\Users\juanmgart\Documents\BUSCADOR\JPMCORDOBA"
...
SHEET_NAME = "JPMCORDOBA"
CARPETA_PDF = r"C:\Users\juanmgart\Documents\BUSCADOR\JPMCORDOBA\pdf"
CARPETA_REVISION = r"C:\Users\juanmgart\Documents\BUSCADOR\JPMCORDOBA\revision"
...
for index, row in df.iterrows():
    ...
    with open(os.path.join(CARPETA_REVISION, f'{date.today()}_revision_JPMCORDOBA.txt'), 'a') as txt_file:
        if found:
