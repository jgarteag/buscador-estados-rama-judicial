...
RUTA_CARPETA_J1PF = r"C:\Users\juanmgart\Documents\BUSCADOR\J1CC"
...
SHEET_NAME = "J1CC"
CARPETA_PDF = r"C:\Users\juanmgart\Documents\BUSCADOR\J1CC\pdf"
CARPETA_REVISION = r"C:\Users\juanmgart\Documents\BUSCADOR\J1CC\revision"
...
for index, row in df.iterrows():
    ...
    with open(os.path.join(CARPETA_REVISION, f'{date.today()}_revision_J1CC.txt'), 'a') as txt_file:
        if found:
